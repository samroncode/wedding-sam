...
const ContactForm = () => {
  ...
  // Config variables
  const SPREADSHEET_ID = publicRuntimeConfig.NEXT_PUBLIC_SPREADSHEET_ID;
  const SHEET_ID = publicRuntimeConfig.NEXT_PUBLIC_SHEET_ID;
  const GOOGLE_SERVICE_ACCOUNT_EMAIL =
    publicRuntimeConfig.NEXT_PUBLIC_GOOGLE_SERVICE_ACCOUNT_EMAIL;
